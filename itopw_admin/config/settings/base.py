...
)  # (itopw_admin/config/settings/base.py - 3 = itopw_admin/)
APPS_DIR = ROOT_DIR.path("itopw_admin")
...
MIGRATION_MODULES = {"sites": "itopw_admin.contrib.sites.migrations"}
...
ADMINS = [("""Sonaln""", "sonaln@example.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "itopw_admin.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "itopw_admin.users.adapters.SocialAccountAdapter"
